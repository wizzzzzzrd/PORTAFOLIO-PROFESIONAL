...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Tecnologías" text2="Mi caja de herramientas digital" text3="Frontend, backend, bases de datos e infraestructura: las tecnologías que elijo para resolver problemas reales, con enfoque en rendimiento, mantenibilidad y despliegue seguro." />
