...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Proyectos" text2="Algunas de mis creaciones..." text3="Proyectos destacados en diferentes tecnologías, frameworks, lenguajes, y arquitecturas" />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Explora todos mis repositorios: proyectos completos, demos y utilidades listos para revisar y clonar.                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img
                            ...
                            src="/pixels-reactjs/assets/features-showcase-1.png"
                    ...
                    >
                        <img
                            src="/pixels-reactjs/assets/features-showcase-2.png"
                            alt="features showcase"
                            width={1000}
                            height={500}
                            className="hover:-translate-y-0.5 transition duration-300 rounded-lg"
                        />
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Nada mejor para observar codigo, que observando codigo. </h3>
                        <p className="text-slate-300 mt-2">Enfoque en buenas prácticas; estructura clara, tests y documentación.</p>
                        <a
                            href={CONTACT_CONFIG.github}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition w-fit"
                        >
                            <span className="font-medium">Ir a Repositorios en GitHub</span>
                            <ArrowUpRight
